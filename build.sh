...
# Test the image to ensure it works correctly
echo "Testing the image..."
docker run --rm --cap-add=NET_ADMIN --device=/dev/net/tun ghcr.io/fluent-networks/tailscale-mikrotik:$VERSION version
